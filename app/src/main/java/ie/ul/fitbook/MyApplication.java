...
/**
 * This class extends the Application class so that we can initialise libraries we need
 */
public class MyApplication extends Application {
    ...
    public void onCreate() {
        super.onCreate();
        AndroidThreeTen.init(this); // need to initialise for date time and duration functionality
    }
}
